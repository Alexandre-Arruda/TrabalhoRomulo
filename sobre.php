...
<div class="container">
    ...
    <div class="card" style="margin-bottom: 32px;">
        <div class="card-content">
            <h2 style="font-size: 32px; margin-bottom: 32px; text-align: center;">Por Que Escolher a Tech Store?</h2>
            ...
            <div class="grid grid-2" style="gap: 24px;">
                <div style="display: flex; gap: 20px;">
                    ...
                    <div>
                        ...
                        <p style="color: var(--text-secondary);">Trabalhamos apenas com marcas oficiais e produtos certificados</p>
                    </div>
                </div>
                ...
                <div style="display: flex; gap: 20px;">
                    ...
                    <div>
                        ...
                        <p style="color: var(--text-secondary);">Melhores preços do mercado com parcelamento sem juros</p>
                    </div>
                </div>
                ...
                <div style="display: flex; gap: 20px;">
                    ...
                    <div>
                        ...
                        <p style="color: var(--text-secondary);">Enviamos para todo o Brasil com prazos ágeis</p>
                    </div>
                </div>
                ...
                <div style="display: flex; gap: 20px;">
                    ...
                    <div>
                        ...
                        <p style="color: var(--text-secondary);">Equipe pronta para tirar suas dúvidas e ajudar</p>
                    </div>
                </div>
                ...
                <div style="display: flex; gap: 20px;">
                    ...
                    <div>
                        ...
                        <p style="color: var(--text-secondary);">Todos os produtos com garantia do fabricante</p>
                    </div>
                </div>
                ...
                <div style="display: flex; gap: 20px;">
                    ...
                    <div>
                        ...
                        <p style="color: var(--text-secondary);">Várias formas de pagamento com total segurança</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card" style="background: linear-gradient(135deg, var(--primary), var(--primary-dark)); color: white; text-align: center;">
        <div class="card-content" style="padding: 64px 32px;">
            <h2 style="font-size: 36px; margin-bottom: 16px; color: white;">Pronto para começar?</h2>
